namespace Bioinformatyka
{
    class Config
    {
        ...
        public static readonly byte OLIGONUKLEOTYD_LEN = 8; // długość oligonukleotydu
        ...
        public static readonly double POZYTYWNE = 0.05; // szansa na blad pozytywny (nadmiarowy oligonukleotyd w spektrum)
